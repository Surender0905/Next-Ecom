  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col justify-between">
        <header>
          <nav className="flex h-12 items-center justify-between shadow-md px-12">
            <Link href="/">
              <a className="text-xl font-bold"> Ecom</a>
            </Link>

            <div>
              <Link href="/cart">
                <a className="p-2 font-medium">
                  Cart
                  {cartItemsCount > 0 && (
